# Xdd
Понятно что работы будет распределены по папкам, но если работа большая я создам для неё отдельную ветку, как в случаем с Пыхой.
![image](https://github.com/Hron0/sharaga/assets/125986219/b9d22035-1548-4b00-8559-0d4b751e1e06)

В ветке **main** вся хуйня. Чтобы сменить ветку просто кликаем на название ветки и в дропдауне выбераем другую ветку.
