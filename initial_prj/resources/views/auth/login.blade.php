...
<div class="w-full flex flex-col items-center relative">
    <form action="{{ route('login/post') }}" method="post" onsubmit="formAction(this, event)" class="flex flex-col items-center w-[45%] bg-slate-900 gap-4">
        @csrf
        <h1 class="text-3xl text-white font-bold mt-4">Вход</h1>
        ...
        <button type="submit" class="text-3xl rounded-md bg-stone-700 px-3 py-2 text-white font-bold">Войти</button>
    </form>
</div>
@endsection