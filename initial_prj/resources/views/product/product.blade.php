@extends('layout.main')
{{-- https://tailgrail.com/tailwind/product-detail --}}
            ...
            <div class="flex flex-wrap -mx-4">
                <div class="w-full mb-8 md:w-1/2 md:mb-0">
                    <div class="sticky top-0 z-50 overflow-hidden ">
                        <div class="relative mb-6 lg:mb-10 lg:h-2/4 flex justify-center">
                            <img src="{{ asset($product->image) }}" alt=""
                                class="object-cover w-[40%] lg:h-full">
                        </div>
                        <div class="px-6 pb-6 mt-6 border-t border-gray-300 dark:border-gray-400 "> {{-- Shipping --}}
                            ...
                            <div class="mt-2 px-7">
                                <a class="text-sm text-purple-400 dark:text-purple-200" href="#">Get delivery
                                    dates</a>
                            </div>
                        </div>
                    </div>
